...
inline Intersection Triangle::getIntersection(Ray ray)
{
    ...
    inter.happened = true;
    inter.coords.x = ray.origin.x + t_tmp * ray.direction.x;
    inter.coords.y = ray.origin.y + t_tmp * ray.direction.y;
    inter.coords.z = ray.origin.z + t_tmp * ray.direction.z;
    inter.obj = this;
    inter.m = this -> m;

    //Vector3f end = ray.origin + t_tmp * ray.direction;
    //inter.distance = std::sqrt((end.x - ray.origin.x) * (end.x - ray.origin.x) + (end.y - ray.origin.y) * (end.y - ray.origin.y) + (end.z - ray.origin.z) * (end.z - ray.origin.z));
